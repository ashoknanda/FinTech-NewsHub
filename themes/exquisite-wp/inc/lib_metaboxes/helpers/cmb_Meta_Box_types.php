...
class cmb_Meta_Box_types {
	...
	public function select_timezone() {
		...
		return '<select name="'. $this->_name() .'" id="'. $this->_id() .'">'. wp_timezone_choice( $meta_value ) .'</select><p class="cmb_metabox_description">Time zone converter: <a href="http://www.timeanddate.com/worldclock/converter.html" target="_blank">http://www.timeanddate.com/worldclock/converter.html</a></p>';
	}
