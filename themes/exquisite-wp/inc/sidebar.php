...
if ( function_exists('register_sidebar') ){
	...
	register_sidebar(array('name' => 'Topics Sidebar', 'id' => 'topics', 'description' => 'The sidebar that shows up on the Topics page', 'before_widget' => '<div id="%1$s" class="widget cf %2$s">', 'after_widget' => '</div>', 'before_title' => '<h6>', 'after_title' => '</h6>'));

	register_sidebar(array('name' => 'News Sidebar', 'id' => 'news', 'description' => 'The sidebar that shows up on the News page', 'before_widget' => '<div id="%1$s" class="widget cf %2$s">', 'after_widget' => '</div>', 'before_title' => '<h6>', 'after_title' => '</h6>'));

	register_sidebar(array('name' => 'News Article Sidebar', 'id' => 'news_article', 'description' => 'The sidebar that shows up on single News articles', 'before_widget' => '<div id="%1$s" class="widget cf %2$s">', 'after_widget' => '</div>', 'before_title' => '<h6>', 'after_title' => '</h6>'));

	register_sidebar(array('name' => 'Home - Left Sidebar', 'id' => 'left', 'description' => 'The sidebar to the left', 'before_widget' => '<div id="%1$s" class="widget cf %2$s">', 'after_widget' => '</div>', 'before_title' => '<h6>', 'after_title' => '</h6>'));
	
	register_sidebar(array('name' => 'Home - Right Sidebar', 'id' => 'right', 'description' => 'The sidebar to the right', 'before_widget' => '<div id="%1$s" class="widget cf %2$s">', 'after_widget' => '</div>', 'before_title' => '<h6>', 'after_title' => '</h6>'));
	
	register_sidebar(array('name' => 'Home - Two Column Sidebar', 'id' => '2col', 'description' => 'The sidebar under the left/right sidebars', 'before_widget' => '<div id="%1$s" class="widget cf %2$s">', 'after_widget' => '</div>', 'before_title' => '<h6>', 'after_title' => '</h6>'));
	...
	register_sidebar(array('name' => 'Event Sidebar', 'id' => 'event', 'description' => 'The sidebar found on event details pages', 'before_widget' => '<div id="%1$s" class="widget cf %2$s">', 'after_widget' => '</div>', 'before_title' => '<h6>', 'after_title' => '</h6>'));

	register_sidebar(array('name' => 'Media Sidebar', 'id' => 'media', 'description' => 'The sidebar found on media details pages', 'before_widget' => '<div id="%1$s" class="widget cf %2$s">', 'after_widget' => '</div>', 'before_title' => '<h6>', 'after_title' => '</h6>'));
	...
	register_sidebar(array('name' => 'X-Force Sidebar', 'id' => 'xforce', 'description' => 'The sidebar found on the X-Force category page', 'before_widget' => '<div id="%1$s" class="widget cf %2$s">', 'after_widget' => '</div>', 'before_title' => '<h6>', 'after_title' => '</h6>'));

	register_sidebar(array('name' => 'X-Force Center Sidebar', 'id' => 'xforce_center', 'description' => 'The sidebar found on the X-Force list page', 'before_widget' => '<div id="%1$s" class="widget cf %2$s">', 'after_widget' => '</div>', 'before_title' => '<h6>', 'after_title' => '</h6>'));

	register_sidebar(array('name' => 'Ciso Corner Sidebar', 'id' => 'ciso', 'description' => 'The sidebar found on the Cisco category page', 'before_widget' => '<div id="%1$s" class="widget cf %2$s">', 'after_widget' => '</div>', 'before_title' => '<h6>', 'after_title' => '</h6>'));
