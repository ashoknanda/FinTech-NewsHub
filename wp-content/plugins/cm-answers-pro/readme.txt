...
* Updated licensing library.
* SEO options fix - now it works with the page templates.
* Disabled showing related questions for posts and pages by default.
* Fixed issue with sticky post join.

= 2.9.20 =
* Added new option Date/time format.

= 2.9.19 =
* Fixed AJAX support in questions shortcode.

= 2.9.18 =
* Fixed issue with showcontent parameter in the shortcodes, added showcontent=fragment value.

= 2.9.17 =
* Added new option to display question's content or fragment on the index page.
* Added new option experts=1 to the cma-categories shortcode to display the experts list column.
* Fixed issue with redirection when anonymous user posted question and only experts can see unanswered questions.
* CSS improvements.

= 2.9.16 =
* Another fix for editing labels.
* Updated licensing api support.

= 2.9.15 =
* Fixed editing labels for the Experts Addon.

= 2.9.14 =
* Fixed issue with displaying anonymous user questions number.
* Added Danish translation.
* Added posting as anonymous option for the logged-in users.
* Rich editor improvements on the ajax pages.
* Fixed email issue when sending private questions.
* CSS improvements.
...
= 2.9.11 =
* Integration with CM Answers Experts Addon.

= 2.9.10 =
* Updated licensing api support.
* Fixed shortcode subtree issue.
* Auto approve by default
* Added new option to show markup box
* CSS improvements

= 2.9.9 =
* Fixed the licensing issue causing the AJAX didn't work.
* Revised pt_BR (Brazilian) translations by Gustavo Thron.
...
* Fixed contributor's page questions filter.
* Fixed contrubutor's page answers limit.
* Fixed editting answer.
* Fixed issue with anonymous users that could edit answers.
* Fixed widget cache id generating which created lots of duplicated transients in the options table.
* Fixed showing login form.
* Fixed issue with sorting shortcode cma-questions.
* Added option to display the additional question title on thread page.
* Added new labels.
