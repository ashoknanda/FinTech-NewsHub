                                        ...
                                        <table class="form-table">
                                            ...
                                            <tr valign="top" class="plan_dependent plan_vip">
                                                <th scope="row"><label><?php _e('Remove branding', LIKEBTN_I18N_DOMAIN); ?> <i class="premium_feature" title="VIP / ULTRA"></i></label>
                                                    <i class="likebtn_help" title="<?php _e('No LikeBtn.com branding link', LIKEBTN_I18N_DOMAIN); ?>">&nbsp;</i>
                                                </th>
                                                <td>
            ...
            array('%admin_ajax%'=>'<a href="'.admin_url('admin-ajax.php').'" target="_blank">/wp-admin/admin-ajax.php</a>')) ?></p>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="param_like_box hidden" style="position:absolute"><small><a target="_blank" href="https://likebtn.com/en/wordpress-like-button-plugin#like_box_template"><?php _e('How to alter like box template?', LIKEBTN_I18N_DOMAIN); ?></a></small></div>
                                                        </td>
                                                    </tr>
