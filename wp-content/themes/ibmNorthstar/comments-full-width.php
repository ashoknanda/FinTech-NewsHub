...
<div class="ibm-blog__comments">
    ...
    <?php if ( comments_open() ) : ?>
        ...
        <div data-widget="showhide" data-type="panel" class="ibm-show-hide">
            <h2 class="ibm-bold ibm-h1"><?php $my_theme = wp_get_theme(); _e('Add Comment', $my_theme->get( 'Name' )); ?> <div class="ibm-item-note"><?php $my_theme = wp_get_theme(); comments_number( __( '<span>No</span> Comments', $my_theme->get( 'Name' ) ), __( '<span>One</span> Comment', $my_theme->get( 'Name' ) ), __( '<span>%</span> Comments', $my_theme->get( 'Name' ) ) );?></div></h2>
