...
(function(window, $){
	...
	$(function(){
		console.log('\n\n\n\t\t\t    O O\n\t\t\t    ---\n\t\t\t  / --- \\\n\t\t\t /| --- |\\\n\t\t\t(_) --- (_)\n\t\t\t     -\n\n\n========================================\n\n\tWELCOME TO IBM THINK MARKETING.\n\n\tFuel for the marketing mind.\n\t(And developers too. ;) )\n\n========================================\n\n\n\n');
		...
		var $beta = $('<span class="beta-designator" style="font-size:0.8em;color:#00B4A0;font-weight:normal;font-family:HelvBoldIBM;margin-left:0.5em;display:none;">BETA</span>');
