...
?>
      ...
      <?php if(isset($ads_group_ids)){ ?>
        
        <!-- <div class="ibm-card__content ibm-link-list"> -->
        <?php
                  $params_sidebar_dfads = 'groups='.$ads_group_ids.'&limit=1&orderby=random&order=DESC&container_class=nh-promo-card-holder';
                  echo dfads($params_sidebar_dfads);   
             ?>
         <!-- </div> -->
